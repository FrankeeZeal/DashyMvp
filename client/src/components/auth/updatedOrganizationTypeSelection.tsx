            ...
            <Card className="bg-gray-800 border-2 border-transparent hover:border-primary-500 transition-all duration-200 shadow-xl hover:shadow-blue-500/20 h-full">
              <div className="p-8 flex flex-col text-center h-full">
                ...
                <div className="mt-auto mx-auto">
                  <button className="px-8 py-2 bg-blue-600 text-white rounded-full font-medium transition-all shadow-lg hover:shadow-blue-500/50 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-800">
                    Next
                  </button>
                </div>
              </div>
